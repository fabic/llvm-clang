...
//===----------------------------------------------------------------------===//
//
// FABIC / 2017-12-25 / IMPORTED FROM Clang 5.0.1
//
// Why?: /me think I need to have a bit more control over the traversal;
//       and specifically: storing states here'n'there, like having a stack
//       for pushing in DeclContext/s.
//
// NOTE: (!) KEEP THIS FILE AS CLOSE TO THE ORIGINAL AS POSSIBLE (!)
//
//===----------------------------------------------------------------------===//
#ifndef PIMPLIO_LLVM_CLANG_AST_RECURSIVEASTVISITOR_H
#define PIMPLIO_LLVM_CLANG_AST_RECURSIVEASTVISITOR_H
...
public:
  ...
  /// \brief FABIC/2017-12-29
  bool shouldVisitFunctionBodies() const { return true; }
...
// FABIC / 2017-12-25: Was private, made protected.
//   I need to override these, but also resort to the original impl.
// private:
protected:
...
/// FABIC/BOOKMARK (we've specialized this one, btw.).
template <typename Derived>
...
bool RecursiveASTVisitor<Derived>::TraverseFunctionHelper(FunctionDecl *D) {
  ...
  if (getDerived().shouldVisitFunctionBodies() // FABIC/2017-12-29
...
#endif // PIMPLIO_LLVM_CLANG_AST_RECURSIVEASTVISITOR_H
