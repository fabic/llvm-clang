...
Env=( CC CXX CFLAGS CXXFLAGS BOOSTROOT BOOST_ROOT BOOST_INCLUDE_DIRS BOOST_LIBRARY_DIRS CPATH CPLUS_INCLUDE_PATH HOME INCLUDE_PATH LD_RUN_PATH LD_LIBRARY_PATH LIBRARY_PATH PATH PKG_CONFIG_PATH SSH_AUTH_SOCK )
