...
//
///////////////////////////////////////////////////////////
// 2015-11-17  https://github.com/fabic/
//
// This is file `cpp_playground/echo.cpp`,
// copy-pasted from `misc/boostcgi/libs/cgi/example/fcgi/echo/main.cpp`
// 
// @link http://cgi.sourceforge.net/docs/fastcgi___cgi/examples/fastcgi_examples.html
//
// Build that thing with :
//
//   clang++ -std=c++11 -I ../misc/boostcgi -lboost_system -lboost_filesystem echo.cpp -o fcgi-bin/echo
//
///////////////////////////////////////////////////////////
#include <iostream>
///////////////////////////////////////////////////////////
